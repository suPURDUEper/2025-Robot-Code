...
public class FullAutoAim implements SwerveRequest {
    ...
    public StatusCode apply(SwerveControlParameters parameters, SwerveModule<?, ?, ?>... modulesToApply) {
        ...
        robotCentricFacingAngle.TargetDirection = Collections.min(reefAngles,
                Comparator.comparing(angle -> absDistanceRadians(angle, facingReefCenter)));
        int aprilTagId = AllianceFlip.shouldFlip() ? reefAngleToAprilTagIdRed.get(robotCentricFacingAngle.TargetDirection)
