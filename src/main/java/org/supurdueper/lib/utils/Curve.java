...
/**
 * This class and its subclasses remap controller stick inputs according to specifics provided of multiple classes of
 * curves.
 *
 * <p>This is the superclass of several types of curves. It contains most of the code that is used for all types of
 * curves (Linear, Exponential, Spline, and Step).
 *
 * <p>To create a Curve, do not create a <code>Curve</code> object directly, use a subclass of <code>Curve</code> such
 * as <code>ExpCurve</code> instead.
 *
...
public abstract class Curve {
     ...
     * </code> in the center of the curve and squishes the rest of the curve to the outside proportionally.
     *
    ...
    /**
     * Prints a set of points on the curve of length <code>pointCount</code>. The output of this method can be pasted
     * into https://www.desmos.com/calculator to see a visual representation of the <code>Curve</code>.
     *
    ...
    /**
     * Sets the value of <code>deadzone</code>, the value for the width in the center of the curve where any input
     * results in an output of <code>0.0</code>.
     *
    ...
    /**
     * Returns the value of <code>scalar</code>, the double value multiplied to the curve before it is offset.
     *
    ...
    /**
     * Returns the value of <code>deadzone</code>, the value for the width in the center of the curve where any input
     * results in an output of <code>0.0</code>
     *
